...
import PushMessageSend from './PushMessageSend';
import checked from '../../assets/images/checked.svg'
const PushMessageLogWarp = styled.div`
  display: flex;
...
const PushMessageLog = () => {
    ...
    return (
        <PushMessageLogWarp>
            {isRegisterMode ? (
                <PushMessageSend onBack={handleBack} />
            )  : (
                <>
                    <PageHeader>
                        <HeaderText className='text-lg'>FCM관리</HeaderText>
                    </PageHeader>
                    <SubHead>
                        <LeftSubArea>
                            <SearchForm />
