...
const UserTermsWrite = ({ onBack }) => {
    ...
    return (
        <CsWarp>
            <PageHeader>
                <HeaderText className='text-lg'>약관 등록</HeaderText>
            </PageHeader>
            <SubHead>
                <BtnArea>
                    <WriteBtn
            ...
            <PageMain>
                <FormContainer>
                    ...
                    <FormRow>
                        <LabelArea>
                            <Label className="text-sm">약관 게시 여부</Label>
                        </LabelArea>
                        <InputContainer>
                            <RadioArea>
                                <Input
                    ...
                    <FormRow>
                        <LabelArea>
                            <Label className="text-sm">약관 타입</Label>
                        </LabelArea>
                        <InputContainer>
                            <InputBox>
                                <option>서비스 이용약관</option>
                                <option>개인정보 수집 및 이용 약관</option>
                            </InputBox>
                        </InputContainer>
                    </FormRow>
                    <FormRow>
                        <LabelArea>
                            <Label className="text-sm">약관 내용</Label>
                        </LabelArea>
                    ...
                    <FormRow>
                        <LabelArea>
                            <Label className="text-sm">약관 버전</Label>
                        </LabelArea>
                        <InputContainer>
                            <Input
                                value={PRODUCT_EN}
