...
const ProductAdd = ({ onBack }) => {
  ...
  return (
    <ProductWarp>
      <PageHeader>
        <HeaderText className='text-lg'>상품 등록</HeaderText>
      </PageHeader>
      <SubHead>
        <BtnArea>
            ...
            <InputContainer>
              ...
              <FileInputWrapper>
                ...
                <ImagePlaceholder htmlFor="product-thumbnail" selectedImage={PRODUCT_THUMNAIL_IMG}>
                  <img
                    src={PRODUCT_THUMNAIL_IMG ? URL.createObjectURL(PRODUCT_THUMNAIL_IMG) : '/assets/icon/img_upload.svg'}
                    alt="상품 썸네일"
                  />
                </ImagePlaceholder>
              </FileInputWrapper>
            ...
            <InputContainer>
              ...
              <FileInputWrapper>
                ...
                <ImagePlaceholder htmlFor="page-thumbnail" selectedImage={PRODUCT_INNER_THUMNAIL_IMG}>
                  <img
                    src={PRODUCT_INNER_THUMNAIL_IMG ? URL.createObjectURL(PRODUCT_INNER_THUMNAIL_IMG) : '/assets/icon/img_upload.svg'}
                    alt="상세 썸네일"
                  />
                </ImagePlaceholder>
              </FileInputWrapper>
